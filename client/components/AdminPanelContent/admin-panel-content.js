AdminPanelContent = {
  ...
  methods: {
    async getAllClients() {
      try {
        const GET_CLIENTS_URL = `${this.BASE_URL}/api/clients`;
    ...
    async getUF() {
      try {
        const GET_UF_LIST_URL = `${this.BASE_URL}/api/clients/uf`;
    ...
    async createClient() {
      try {
        const POST_CLIENT_URL = `${this.BASE_URL}/api/clients`;
    ...
    async editClient() {
      try {
        ...
        const UPDATE_CLIENT_URL = `${this.BASE_URL}/api/clients/${id}`;
    ...
    async deleteClient() {
      try {
        const id = this.client_id;
        const DELETE_CLIENT_URL = `${this.BASE_URL}/api/clients/${id}`;
    ...
    async getClientInfo() {
      try {
        const id = this.client_id;
        const GET_CLIENT_URL = `${this.BASE_URL}/api/clients/${id}`;
    ...
    async searchClient() {
      try {
        ...
        if (formattedValue !== "") {
          const SEARCH_CLIENT_API = `${this.BASE_URL}/api/clients/search/${formattedValue}`;
